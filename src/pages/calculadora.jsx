...
function Ayudas_visuales() {
  ...
  const visualAids = [
    { id: 1, title: 'CLasificacion de la tension arterial' },
    { id: 2, title: 'Riesgo cardiovascular a 10 años' },
    { id: 3, title: 'Indice de riesgo TIMI' },
    { id: 4, title: 'Puntuacion CHA2DS2VASC' },
    { id: 5, title: 'Escala de reconocimiento de accidentes cerebrovasculares en urgencias (ROSIER)' },
 { id: 6, title: 'Clasificacion funcional de la insuficiencia cardiaca de la New Yoirk Heart Association (NYHA)' },
  { id: 7, title: 'Calculadora ACV: Protoloco de IMA' },
  ];
