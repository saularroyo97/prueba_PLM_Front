...
import iconoPubmed from '../assets/images/desk_iconoPubmed_1.svg';
import iconoPubmedx425 from '../assets/images/iconoPubmed.svg';
import iconoAbstracts from '../assets/images/desk_iconoAbstracts.svg';
import iconoAbstractsx425 from '../assets/images/iconoAbstracts.svg';
...
function Panel_biblioteca() {
  ...
  const logoCard = {
    img: isMobile ? titSecBibliotecax425 : titSecBiblioteca,
    path: '/',
  };

  const otherCards = [
    {
      img: isMobile ? iconoPubmedx425 : iconoPubmed,
      path: '/pubmed',
    },
    {
      img: isMobile ? iconoAbstractsx425 : iconoAbstracts,
      path: '/abstracts', 
    },
  ];
